    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-lg z-10">
        <div className="bg-slate-900/80 border border-slate-800 backdrop-blur-xl py-8 px-6 shadow-2xl rounded-3xl sm:px-10">
          ...
          <div className="mb-6 pb-6 border-b border-slate-800">
            ...
            <div className="grid grid-cols-3 gap-2.5">
              <button
                ...
                className="flex flex-col items-center justify-center p-3 rounded-2xl bg-slate-800/80 hover:bg-indigo-600/20 border border-slate-700/60 hover:border-indigo-500/50 text-slate-200 hover:text-indigo-300 transition-all duration-200 group text-center"
              >
              ...
              <button
                ...
                className="flex flex-col items-center justify-center p-3 rounded-2xl bg-slate-800/80 hover:bg-sky-600/20 border border-slate-700/60 hover:border-sky-500/50 text-slate-200 hover:text-sky-300 transition-all duration-200 group text-center"
              >
              ...
              <button
                ...
                className="flex flex-col items-center justify-center p-3 rounded-2xl bg-slate-800/80 hover:bg-emerald-600/20 border border-slate-700/60 hover:border-emerald-500/50 text-slate-200 hover:text-emerald-300 transition-all duration-200 group text-center"
              >
          ...
          {/* Feature Highlights */}
          <div className="mt-6 pt-6 border-t border-slate-800/80 grid grid-cols-2 gap-3 text-[11px] text-slate-400">
